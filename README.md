...
There is a chance the *'lightdm'* isn't working, in which case you need to enable the service manually: *'sudo systemctl enable lightdm.service -f'*. There is also a change the cursor theme isn't working everywhere, I haven't figured this out yet..!
